...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('login') is-invalid @enderror"
                                             type="text" id="login" name="login" required="" placeholder="Enter your email">
                                        @error('login')
        ...
        <footer class="footer footer-alt">
            2015 - <script>document.write(new Date().getFullYear())</script> &copy; NWY <a href="" class="text-white-50">POS-EMS</a> 
        </footer>
